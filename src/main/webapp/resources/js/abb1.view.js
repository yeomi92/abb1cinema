...
function adminGnbView(){
 ...
 function adminMovieRegisterView(){
    ...
    +'         <tr style="height:40px;">'
    +'            <td>시놉시스</td>'
    +'            <td><textarea name="" id="synopsys" cols="30" rows="6"></textarea></td>'
    +'         </tr>'
    +'         <tr style="height:40px;">'
    +'            <td>감독 이름</td>'
    ...
    +'            <td><input id="trailer_main" type="checkbox"/></td>'
...
function customerMypageView(){
	return '<div id="mypage" class="abb1_find_id_container">'
    	...
    	+'			<ul>'
    	+'				<li>'
    	+'					<a id="mypageReservationInfo" class="noHover" href="#">예매/구매내역</a>'
    	+'				</li>'
    	+'				<li>'
...
function customerMypageInfoView(){
	...
	+'				</li>'
	+'				<li>'
	+'					<a class="noHover" class="noHover" href="#">나의 정보관리</a>'
	+'				</li>'
	+'			</ul> '
	+'		</div>'
	+'		<div id="mypage_reservation_content">'

...
<div id="movieDetail">
<div id="movieTrailer">
	<img src="${context}/resources/img/movie/movie_trailer_2.PNG" alt="분노의 질주 : 더 익스트림" />
</div>
<div id="movieInfo">
	<div>
	<ul>
	<li>
		<table>
			<tr>
				<td>
					<img src="${context}/resources/img/movie/movie_poster_2.png" width="228px" height="333.99px" alt="...">
				</td>
			</tr>
			<tr>
				<td></td>
	...
	<div class="abb1_movie_review_box">
		<table class="abb1_movie_review_table">
			...
			<tr class="abb1_nowMovie_border">
				...
				<td class="abb1_movie_review_btn"><a href=""><span class="abb1_movie_review_btn_text">입력</span></a></td>
			</tr>
		</table>
	</div>

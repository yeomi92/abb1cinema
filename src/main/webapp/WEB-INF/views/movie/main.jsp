...
<nav aria-label="Page navigation">
  <ul class="pagination">
    <li><a href="#" style="background-color: #231f20; color: #efebdb; padding: 11px 30px;margin-left: 20px;border: 2px solid #efebdb;font-size: 17px;">현재상영작</a></li>
    <li><a href="#" style="background-color: #efebdb; color: #231f20; padding: 11px 30px;margin-left: 10px;font-size: 17px;">상영예정작</a></li>
  </ul>
</nav>
</div>
...
<div class="abb1_width_center" style="padding-top: 30px; margin-bottom: 50px;">
	<ul class="abb1_ul_inline">
		<li class="abb1_li_inline">
			<table class="abb1_nowMovie_table abb1_nowMovie_border abb1_nowMovie_padding">
				<tr>
		...
		<li class="abb1_li_inline">
			<table class="abb1_nowMovie_table abb1_nowMovie_border abb1_nowMovie_padding">
				...
				<tr>
					<td class="abb1_nowMovie_border abb1_nowMovie_padding" style="color: #919191;padding-left: 10px;">예매율 15.9% | 관람평점 9.0</td>
				</tr>
			</table>
		</li>
		<li class="abb1_li_inline">
